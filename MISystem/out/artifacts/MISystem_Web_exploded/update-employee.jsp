                ...
                <div class="ibox-content">
                    <form method="get" action="addEmployee" class="form-horizontal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <select name="deptno" id="dfk" class="selectpicker form-control">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="roleid" id="roleid" class="selectpicker form-control">
    ...
    $(document).ready(function() {
        ...
        function loadSelect(){
            ...
            $.ajax({
                ...
                dataType:'json',
                success:function (rs) {
                    $(rs.dept).each(function(index,item){
                        var option="<option value='"+item.deptno+"'>"+item.dname+"</option>";
                        $("#dfk").append(option);
                    });
                    $(rs.role).each(function(index,item){
