...
<body>
<form action="../updateRegister" method="post" class="definewidth m20">
    ...
    <tr>
        ...
        <td>
        	<select name="department" id="department">
        		<option value="0" <c:if test="${register.department == 0 }">selected</c:if>>急诊科</option>
        		<option value="1" <c:if test="${register.department == 1 }">selected</c:if>>儿科</option>
        		<option value="2" <c:if test="${register.department == 2 }">selected</c:if>>妇科</option>
        		<option value="3" <c:if test="${register.department == 3 }">selected</c:if>>皮肤科</option>
        		<option value="4" <c:if test="${register.department == 4 }">selected</c:if>>内分泌科</option>
        		<option value="5" <c:if test="${register.department == 5 }">selected</c:if>>牙科</option>
